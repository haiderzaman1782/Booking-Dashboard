...
export function Payments({ payments, appointments, onPaymentCreated }) {
  ...
  const handleCreatePayment = async () => {
    ...
    try {
      ...
      setNewPayment({ customerName: '', appointmentId: '', paymentMethod: 'Stripe', amount: '', status: 'pending', date: new Date().toISOString().split('T')[0], service: '' });
        ...
        <DialogContent className="dark:bg-gray-800 dark:border-gray-700 max-w-2xl">
          ...
          <div className="space-y-4 py-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium dark:text-gray-300">Appointment ID</label>
                <Input
